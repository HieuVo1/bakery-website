        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(nullable: false),
                    UserAppId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Carts",
                columns: new[] { "Id", "Created_At", "Price", "UserAppId", "UserId" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 20000m, null, new Guid("00000000-0000-0000-0000-000000000000") },
                    { 2, new DateTime(2020, 6, 2, 10, 44, 17, 506, DateTimeKind.Local).AddTicks(5183), 0m, null, new Guid("69bd714f-9576-45ba-b5b7-f00649be00de") }
                });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "ImagePath", "IsShowOnHome", "Status" },
                values: new object[] { 1, null, true, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "9849087e-0c74-4ff9-8cbd-1f428f56f0a6", "Administrator role", "admin", "admin" },
                    { new Guid("8d04dce2-969a-435d-bba4-df3f325983dd"), "f873134a-5d8c-4d0f-bd96-3a330c0d8ac6", "Client role", "client", "client" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "Address", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FullName", "ImagePath", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RoleID", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, null, "a983235a-0bfb-4046-8d96-ad3f7edc5ba8", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "hieuvo044@gmail.com", true, null, null, false, null, "hieuvo044@gmail.com", "admin", "AQAAAAEAACcQAAAAELTHBUMTGZenucPw1r810CrmVUyKK4NOiFkPtzsK8OjzRTMM4EYlmRA5cfdWQkx8lQ==", null, false, new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "!23", 0L, "http://product.hstatic.net/1000026716/product/81ax00mcvn_bd76b8bf0aed4307bc9714e4dc5830f0_large.jpg", true, 1 });

            migrationBuilder.InsertData(
                table: "ProductImages",
                columns: new[] { "Id", "Caption", "FileSize", "ImagePath", "ProductId" },
                values: new object[] { 2, "!23", 0L, "http://product.hstatic.net/1000026716/product/81ax00mcvn_bd76b8bf0aed4307bc9714e4dc5830f0_large.jpg", 1 });
